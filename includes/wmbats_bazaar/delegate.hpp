...
#ifndef BAZAAR_UTILITIES_DELEGATES_H
#define BAZAAR_UTILITIES_DELEGATES_H
...
//  assert(stub_ptr);
    ...
    namespace std
    {
        ...
        struct hash<::bzr::delegate<R( A... )> >
        {
            size_t operator()( ::bzr::delegate<R( A... )> const& d ) const noexcept
            {
